...
import { Fragment } from "react"; // Menggunakan Fragment dari 'react'
...
const Kontak = () => {
  ...
  const Kontak = async (e) => {
    ...
    try {
      ...
      // Setelah berhasil mendaftar, navigasi ke halaman kontak
      Navigate.push("/kontak");
    } catch (error) {
      if (error.response) {
                  ...
                  <div className="col-12">
                    <div className="form-group">
                      <textarea
                        ...
                        onblur="this.placeholder = 'Tulis pesan disini'"
